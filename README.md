...
In general, for complex images, we can do better to center and scale the data. The standard technique for image pre-processing is mean centering and scaling with standard deviation. I am unable to find a research paper introducing this technique, but it has been in common practice among deep learning practitioners. Here is an example of a [blog post](https://becominghuman.ai/image-data-pre-processing-for-neural-networks-498289068258) explaining normalization technique.
